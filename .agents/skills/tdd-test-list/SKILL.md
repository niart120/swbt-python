...
実装前に、観測可能な振る舞いを小さい test item に分ける。README、利用者向け docs、公開 API docstring、release notes だけの作業には使わず、`docs-quality-review` と文書検証計画へ分岐する。
...
- 公開文書を併せて更新する場合、自然言語の説明を item や assertion の期待値にしない。文書の根拠と読みやすさは `docs-quality-review` で確認する。
