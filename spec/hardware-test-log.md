...
### 2026-07-20: unit_052 exp local profile fresh pairing / normal close
...
- notes: fresh profile 作成、pairing key 保存、normal close は hardware-pass。同一 profile bytes を維持した active reconnect と、advertising / pairing / key update を行わないことは次の gate で確認する
