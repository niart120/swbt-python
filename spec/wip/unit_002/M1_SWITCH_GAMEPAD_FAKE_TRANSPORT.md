...
| todo | `wait_connected()` が fake connected callback を待って完了する | new | integration | no | timeout path も分ける |
...
| `uv run pytest tests\unit tests\integration -q` | pass | 67 passed。root export 更新後の unit と fake transport integration を確認した |
