...
| `uv run pytest tests\unit tests\integration -q` | pass | 76 passed。unit と fake transport integration を確認した |
| `uv run ruff format --check .` | pass | 28 files already formatted |
