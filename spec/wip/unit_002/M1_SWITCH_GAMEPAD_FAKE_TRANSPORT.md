...
| `uv run pytest tests\unit tests\integration -q` | pass | 69 passed。unit と fake transport integration を確認した |
| `uv run ruff format --check .` | pass | 27 files already formatted |
