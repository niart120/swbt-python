...
| context manager prerequisite | `async with` を resource scope に寄せ、HID advertising / pairing / reconnect を明示 API へ移す | `spec/wip/unit_015/CONTEXT_MANAGER_RESOURCE_SCOPE.md` |
