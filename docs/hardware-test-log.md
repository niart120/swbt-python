...
| macOS | 未検証 | 未検証 | 未記録 | 未検証 | 未検証 | 未検証 | 未検証 | 未検証 | 未検証 | 未検証 | template only | 2026-07-04 | experimental。CI は実ハードなしの範囲だけで、adapter listing / open、OS Bluetooth stack 設定、pairing、input reflection は未確認 |
