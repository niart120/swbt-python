...
| Linux | 未検証 | libusb 想定 | 未記録 | 未検証 | 未検証 | 未検証 | 未検証 | 未検証 | 未検証 | 未検証 | template only | 2026-07-04 | experimental。準備候補は docs/hardware.md に残すが、adapter listing / open、pairing、input reflection は未確認 |
| macOS | 未検証 | 未検証 | 未記録 | 未検証 | 未検証 | 未検証 | 未検証 | 未検証 | 未検証 | 未検証 | template only | 2026-07-04 | experimental。CI は no-hardware gate だけで、adapter listing / open、OS Bluetooth stack 設定、pairing、input reflection は未確認 |
