...
- Do not present Joy-Con hardware compatibility beyond the recorded Windows 11 / CSR8510 A10 / WinUSB / Switch 2 firmware 22.1.0 profile scenarios. Exact SDP parity, Linux, Joy-Con on macOS, other dongles, other firmware, full Joy-Con stick calibration UI completion, and pairing-free incoming bond reuse are not confirmed.
